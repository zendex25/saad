...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { firstname: @professor.firstname, lastname: @professor.lastname, middleinitial: @professor.middleinitial, status: @professor.status }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { firstname: @professor.firstname, lastname: @professor.lastname, middleinitial: @professor.middleinitial, status: @professor.status }
    assert_redirected_to professor_path(assigns(:professor))
  end
